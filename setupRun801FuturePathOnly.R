# setupRun801FuturePathOnly.R  12/08/2013
# CRR code removed/commented out; Code for Rutkowski remains
...
#
# 12/08/2013 Replaced path generation with single IBM real path
...
#  drift     = constants['drift']
  ...
  ibmCore = coredata(ibm)
  pathMatrix = matrix(ibmCore,ncol=1)
  #
...
#  constants['priceBaseCRR']      = priceBaseCRR
  ...
  #
  #########################################################################
  ##### COMMENTED OUT COMPUTATION OF CRR u,d MATRIX
...
#                       dimnames=dimNamesDelta)
  ###################################################################
  #  COMMENTED OUT CODE FOR CRR COMPUTATION -

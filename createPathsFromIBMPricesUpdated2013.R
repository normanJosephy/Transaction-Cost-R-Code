# createPathsFromIBMPricesUpdated2013.R  9/9/2013
# 
...
# 
createPathsAndJumpsFromIBMFridayData = function(nPaths=100,
                                          nNewPointsOnPath=8,
                                          S0=180) {
...
testNewPathConstruction = function() {
  nPaths=5
  ans = createPathsAndJumpsFromIBMFridayData(nPaths=nPaths)
  print(ans)
  ansa = createPathsAndJumpsFromIBMEndOfMonthData(nPaths=nPaths)
  print(ansa)
  invisible(list(friday=ans,month=ansa))
}

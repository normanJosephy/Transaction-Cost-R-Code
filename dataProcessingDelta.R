# dataProcessingDelta.R  6/29/2012
...
processDelta = function(costBigRut,
                        deltaBigRut,
                        costBigCRR,
                        deltaBigCRR,
                        udMatrixCRR,
  ...
  #  
  dp1 = densityPairPlot(dataSet1=deltaBigCRR,
                  dataSet2=deltaBigRut,
                  xlab=expression(delta),
                  legendText=c('CRR','Rut'),
                  mainText=mainSmallDelta)
  #
  #
  ...
  dataSetList = list(totalDeltaRut,totalDeltaCRR,
                     totalDeltaRutDiscounted,
                     totalDeltaCRRDiscounted)
  
  dp2 = densityListPlot(dataSetList,printIt=TRUE,
    xlab=expression(delta),
    legendText=c('Rut','CRR','RutDiscounted','CRRDiscounted'),
    mainText='delta distributions')
  
  dp3 = densityPairPlot(dataSet1=totalDeltaCRR,
                  dataSet2=totalDeltaRut,
                  xlab=expression(Delta),
                  legendText=c('CRR','Rut'),
                  mainText=mainLargeDelta)
  #
